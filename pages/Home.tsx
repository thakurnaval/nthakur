  ...
  return (
    <>
      <SEO 
        ...
        description="Naval Thakur is an expert consultant in DevSecOps, FinOps, GenAI, and System Architecture. He helps enterprises build resilient, cost-effective, and secure cloud ecosystems."
      />
      {/* Hero Section */}
      ...
      <Section bg="gray">
        <div className="max-w-4xl mx-auto bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl p-8 md:p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
             <Link to="/contact?topic=Consulting" className="px-8 py-3 bg-primary text-white font-semibold rounded-md hover:bg-slate-800 transition-colors">
               Get in Touch
             </Link>
