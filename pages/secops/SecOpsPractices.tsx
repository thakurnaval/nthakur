...
const SecOpsPractices: React.FC = () => {
  return (
    ...
    >
      <h3 className="text-2xl font-bold text-primary dark:text-white mb-4">Core Operational Practices</h3>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-200 dark:border-slate-700">
          <ShieldAlert className="w-8 h-8 text-secondary mb-3" />
          <h4 className="font-bold text-primary dark:text-white mb-2">Incident Response</h4>
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-200 dark:border-slate-700">
          ...
          <h4 className="font-bold text-primary dark:text-white mb-2">Continuous Monitoring</h4>
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-200 dark:border-slate-700">
          ...
          <h4 className="font-bold text-primary dark:text-white mb-2">Red & Blue Teaming</h4>
      ...
      <h3 className="text-xl font-bold text-primary dark:text-white mb-2">The SOC Evolution</h3>
      <p className="mb-4">
