...
const GenAIFundamentals: React.FC = () => {
  return (
    ...
    >
      <h3 className="text-2xl font-bold text-primary dark:text-white mb-4">How it Works</h3>
      <p className="mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white dark:bg-slate-800 p-6 rounded shadow-sm">
          <h4 className="font-bold text-primary dark:text-white mb-2">Tokens</h4>
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded shadow-sm">
          <h4 className="font-bold text-primary dark:text-white mb-2">Context Window</h4>
          <p className="text-sm">The "short-term memory" of the model. How much text it can consider at once (e.g., 8k, 32k, 128k).</p>
        </div>
        <div className="bg-white dark:bg-slate-800 p-6 rounded shadow-sm">
          <h4 className="font-bold text-primary dark:text-white mb-2">Temperature</h4>
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded shadow-sm">
          <h4 className="font-bold text-primary dark:text-white mb-2">Embeddings</h4>
