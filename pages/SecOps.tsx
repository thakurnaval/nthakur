          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               ...
               <div className="flex flex-col gap-3">
                 ...
                 <p className="text-slate-600 dark:text-slate-400 text-sm">
                   Automated security scanning (SAST/DAST), policy-as-code, and continuous compliance monitoring within the pipeline.
                 </p>
               </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white">Security as Code</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white">Continuous Monitoring</h4>
          ...
          <div className="lg:col-span-1">
             <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700">
               ...
               <div className="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
                  <Link to="/contact" className="text-center block text-sm font-bold text-primary dark:text-secondary hover:text-primary/80 dark:hover:text-secondary-hover">
